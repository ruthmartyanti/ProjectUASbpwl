...
<head>
	<!-- start: Meta -->
	<meta charset="utf-8">
	<title>DistroIT | Distro Online telengkap dan terpercaya</title> 
	<meta name="description" content="Distro, terlengkap, information, technology baru, murah"/>
	<meta name="keywords" content="Kaos, Murah, Baru, terlengkap, harga, terjangkau" />
	<meta name="author" content="Ambika Masril Ruth"/>
	<!-- end: Meta -->
			            		...
			            		<ul class="nav">
									...
									<li class="dropdown">
										...
										<ul href="#" class="dropdown-menu">
											...
											<li><a href="ruth-google/index.php">Konsumen</a></li>
			                  	</ul>
			          		</div>
			        	</div>
			      	</div>
...
?>
        		<!--<div class="span4">-->
                    ...
                    <tr>
                        ...
                        <td><h3>Stock</h3></td>
                        <td><h3>:</h3></td>
                        <td><div><h3><?php if ($data['br_stok'] > 2){
...
<!---->
    	...
    	<div class="container">	
			...
			<div class="clients-carousel">
				...
				<ul class="slides clients">
					<li><img src="img/logos/brands1.jpg" alt=""/></li>
					<li><img src="img/logos/brands2.jpg" alt=""/></li>	
					<li><img src="img/logos/brands3.jpg" alt=""/></li>
					<li><img src="img/logos/brands4.jpg" alt=""/></li>
					<li><img src="img/logos/brands5.png" alt=""/></li>
					<li><img src="img/logos/brands6.jpg" alt=""/></li>
					<li><img src="img/logos/brands7.jpg" alt=""/></li>
					<li><img src="img/logos/brands8.jpg" alt=""/></li>
					<li><img src="img/logos/brands9.jpg" alt=""/></li>
					<li><img src="img/logos/brands10.jpg" alt=""/></li>				
				</ul>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="span3">
					<h3>Alamat Kami</h3>
					Jl Rowosari <br />
                    Telp : 081266198552<br />
                    Email :
					<br>
					<a href="ambika17ti@mahasiswa.pcr.ac.id">ambika17ti@mahasiswa.pcr.ac.id</a> <a href="ambika17ti@mahasiswa.pcr.ac.id"></a>
					 <a href="masril17ti@mahasiswa.pcr.ac.id">masril17ti@mahasiswa.pcr.ac.id</a> <a href="masril17ti@mahasiswa.pcr.ac.id"></a>
					  <a href="ruth17ti@mahasiswa.pcr.ac.id">ruth17ti@mahasiswa.pcr.ac.id</a> <a href="ruth17ti@mahasiswa.pcr.ac.id"></a>
					 </div>
				<!-- end: Photo Stream -->
	...
	<div id="copyright">
		...
		<div class="container">
			...
			<p>
				Copyright &copy; <a href="http://www.niqoweb.com">DistroIT 2018</a> <a href="http://bootstrapmaster.com" alt="Bootstrap Themes"></a> designed by AMBIKA | MASRI | RUTH
			</p>
